...
<div
	class={`flex items-end flex-shrink-0 border-t-[0.5px] border-zinc-850 ${$vcRoom ? 'h-[7.5rem]' : 'h-[4rem]'}  transition-[height] duration-200 relative overflow-hidden bg-zinc-960 backdrop-blur-xl rounded-bl-[0.5rem] `}
>
	<div
